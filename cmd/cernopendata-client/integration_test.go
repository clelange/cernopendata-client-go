...
func TestIntegrationListDirectory(t *testing.T) {
	...
	cmd := exec.CommandContext(ctx, getBinaryPath(), "list-directory", "--path", "root://eospublic.cern.ch//eos/opendata/cms")
	output, err := cmd.CombinedOutput()
	if err != nil {
...
func TestIntegrationListDirectoryVerbose(t *testing.T) {
	...
	cmd := exec.CommandContext(ctx, getBinaryPath(), "list-directory", "--path", "root://eospublic.cern.ch//eos/opendata/cms", "--verbose")
	output, err := cmd.CombinedOutput()
	if err != nil {
...
func TestIntegrationListDirectoryWrongPath(t *testing.T) {
	...
	cmd := exec.CommandContext(ctx, getBinaryPath(), "list-directory", "--path", "root://eospublic.cern.ch//eos/opendata/foobar")
	output, err := cmd.CombinedOutput()
	if err != nil {
...
func TestIntegrationListDirectoryEmpty(t *testing.T) {
	...
	cmd := exec.CommandContext(ctx, getBinaryPath(), "list-directory", "--path", "root://eospublic.cern.ch//eos/opendata/test/nonexistent")
	output, err := cmd.CombinedOutput()
...
func TestIntegrationListDirectoryRecursive(t *testing.T) {
	...
	cmd := exec.Command(getBinaryPath(), "list-directory", "--path", "root://eospublic.cern.ch//eos/opendata/cms/software/HiggsExample20112012", "--recursive")
	output, err := cmd.CombinedOutput()
	if err != nil {
...
func TestIntegrationListDirectoryTimeout(t *testing.T) {
	...
	cmd := exec.Command(getBinaryPath(), "list-directory", "--path", "root://eospublic.cern.ch//eos/opendata/cms/software/HiggsExample20112012", "--timeout", "1")
	output, err := cmd.CombinedOutput()
